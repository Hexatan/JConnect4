...
/**
 * processeur g�rant l'entr� de texte dans un TextField dynamiquement.
 *
 * @author gaetan
 */
public class KeyboardProcessor implements InputProcessor {

	/** TextField �tant modifier par le processeur. */
	TextField text;
	 ...
	 *
	 * @param text            TexteField utilis� par le processeur
	 * @param str            String utlis� par le processeur
	 */
