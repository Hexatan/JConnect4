...
public class UtilMenu {
	 ...
	 *            Texte du bouton
	 * @param style
	 *            TextButtonStyle a ajouté au bouton
	 * @param y
	 *            position en y du bouton
	 * @param il
	 *            inputLIstener a appliquer au bouton
	 * @return Retourne le bouton créer
	 */
	 ...
	 * 
	 * @param style
	 *            TextButtonStyle à modifier
	 * @param skin
	 *            Skin dans lequel récuperer les images
	 * @param font
	 *            BitmapFont à ajouter dans le style
	 * @param img
	 *            String représentant l'image du bouton dans l'atlas
	 * @param imgPress
	 *            String représentant l'image du bouton pressé dans l'atlas
	 */
	 ...
	 * 
	 * @param style
	 *            style TextFieldStyle à modifier
	 * @param font
	 *            BitmapFont à ajouter dans le style
	 */
